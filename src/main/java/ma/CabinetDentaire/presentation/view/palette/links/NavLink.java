package ma.CabinetDentaire.presentation.view.palette.links;
    ...
    public void _init() {
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e) {
                if(text.equals("Deconnexion")) textLabel.setForeground(currentTheme.redColor());
                else textLabel.setForeground(currentTheme.greenColor());
            }
...
//    }
    ...
    public NavLink(Theme currentTheme,String text, String iconSrc) {
