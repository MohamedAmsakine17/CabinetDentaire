...
public class MyButton extends JButton {
    ...
    public MyButton(Theme currentTheme, String text, Color bgColor, Color hoverColor) {
        ...
        this.font = new MyLabel(currentTheme,this.text,22,1);
        add(font);

        _init();
    }

    public MyButton(Theme currentTheme, String text, int fontSize, Color bgColor, Color hoverColor ,String iconSrc, int iconSize) {
        this.currentTheme = currentTheme;
        ...
        this.font = new MyLabel(currentTheme,this.text,fontSize,1,iconSrc,iconSize);
        add(font);
        _init();
    }
