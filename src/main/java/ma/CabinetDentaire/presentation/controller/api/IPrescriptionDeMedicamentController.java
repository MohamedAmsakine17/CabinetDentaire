...
public interface IPrescriptionDeMedicamentController {
    void createPrescription(int unitesMin, int unitesMax, String contraintesAlimentation, Long ordonnanceId, String contraintesTemps, Long medicamentId) throws PrescriptionDeMedicamentException;
